...
- **React Standards** - Test component interactions and workflows
- **Pure Functions Guide** - Understand component logic boundaries
- **CSS Modules Styling Standards** - Test responsive behavior
...
- [React Standards](mdc:react.mdc) - For component structure and accessibility requirements
- [Pure Functions Guide](mdc:pure-functions.mdc) - For understanding component logic boundaries
- [CSS Modules Styling Standards](mdc:styling-css-modules.mdc) - For testing responsive behavior and styling

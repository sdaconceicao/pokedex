...
1. Run `pnpm install`
2. Run `pnpm run start:dev` in the backend/pokedex-graphql folder
3. Run `pnpm run start:dev` in the backend/pokedex-rest folder
4. Run `pnpm run start:dev` in the frontend folder
